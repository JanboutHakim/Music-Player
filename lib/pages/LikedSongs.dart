...
class _LikedSongsState extends State<LikedSongs> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:Column(
        children: [
          MyAppBar(firsticon: Icons.arrow_back,secondicon: Icons.settings_rounded,onPressed: (){Navigator.pop(context);},size: 40),
          Container(
              ...
              child: Row(
                ...
                children: [
                  Padding(padding: EdgeInsets.fromLTRB(_screenWidth * 0.05, 0, 0, 0),
                    ...
                    child: Text('Liked Songs', style: setStyle(normalmodebackground, 24, true)),
                  ),
                ],
              ),
            ),
          ...
          Expanded(
            child: GridView.builder(
              ...
              return Container(height: _screenHeight*0.65,
                  child: Songs(song: s,width:  50,onTab: (){Navigator.push(context, MaterialPageRoute(builder: (context)=> PlayinSong(sng: index)));},));
            }),
          ),
        ],

          ...
          Container(
            ...
            child: Row(crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                Image.asset(widget.song.imagepath, fit: BoxFit.cover, width: MediaQuery.of(context).size.width*20/100),
                  Column(crossAxisAlignment: CrossAxisAlignment.start,
                      children:[
                    Text(widget.song.title,style:  setStyle(normalmodebackground, 20, false),),
                    Text(widget.song.subtitle,style: setStyle(normalmodebackground, 10, false),)]
                  ),
